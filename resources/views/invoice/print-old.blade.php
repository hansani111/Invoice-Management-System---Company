                            ...
                            <div class="card-box">
                                ...
                                <div class="row text-center ">
                                    <div class="col-md-4 border p-0">
                                        ...
                                        <div class="row pl-2 pt-1">
                                            <div class="col-12 d-flex justiy-content-start">
                                                <label for="">Name : {{ $bill->company->name }}</label>
                                                <input type="text" style="border: none; line-height: -10;">
                                            </div>
                                        </div>
                                        <div class="row pl-2">
                                            <div class="col-12 d-flex justiy-content-start">
                                                <label for="">Address : {{ $bill->company->address }}</label>
                                                <span></span>
                                            </div>
                                        </div>
                                        <div class="row pl-2">
                                            <div class="col-12 d-flex justiy-content-start">
                                                <label for="">Contact No :
                                                    {{ $bill->company->contact_no }}</label>
                                                <span></span>
                                            </div>
                                        </div>
                                        <div class="row pl-2 pb-1">
                                            <div class="col-12 d-flex justiy-content-start">
                                                <label for="">State : {{ $bill->company->state }}</label>
                                                <span></span>
                                            </div>
                                            <div class="col-12 d-flex justiy-content-start">
                                                <label for="">PinCode : {{ $bill->company->pin_code }}</label>
                                                <span></span>
                                            </div>
                                            {{-- <div class="col-12 d-flex pb-1">
                                                <label for="">PinCode : <span><b></b></span> </label>
                                        ...
                                        <div class="row pl-2 pt-1">
                                            <div class="col-12 d-flex justiy-content-start">
                                                <label for="">Account Holder Name :
                                                    {{ $accountDetail->account_holder_name }}</label>
                                                <span></span>
                                            </div>
                                        </div>
                                        <div class="row pl-2">
                                            <div class="col-12 d-flex justiy-content-start">
                                                <label for="">Account Number :
                                                    {{ $accountDetail->account_number }}</label>
                                                <span></span>
                                            </div>
                                        </div>
                                        <div class="row pl-2">
                                            <div class="col-12 d-flex justiy-content-start">
                                                <label for="">Branch : {{ $accountDetail->branch }}</label>
                                                <span></span>
                                            </div>
                                        </div>
                                        <div class="row pl-2">
                                            <div class="col-12 d-flex justiy-content-start">
                                                <label for="">Bank Address :
                                                    {{ $accountDetail->bank_address }}</label>
                                                <span></span>
                                            </div>
                                        </div>
                                        <div class="row pl-2 pb-1">
                                    ...
                                    <div class="col-md-3 border p-0">
                                        ...
                                        <div class="row pl-2 pt-1">
                                            <div class="col-12 d-flex justiy-content-start">
                                                <label for="">Reference No : {{ $bill->reference_no }}</label>
                                                <span></span>
                                            </div>
                                        </div>
                                        <div class="row pl-2">
                                        ...
                                        <div class="row pl-2 pb-1">
                                            <div class="col-12 d-flex justiy-content-start">
                                                <label for="">Reference Date :
                                                    {{ $bill->reference_date }}</label>
                                                <span></span>
                                            </div>
                                            {{-- <div class="col-12 d-flex pb-1">
                                    ...
                                    <div class="col-sm-6 col-lg-3 mt-1">
                                        <ul class="list-unstyled">
                                            <li><b>Total :</b> <span class="float-right"><i
                                                    ...
                                                    {{ $bill->invoice_amount }}</span></li>
                                            <li><b>TAX :</b><span class="float-right"><i
                                                        class="fas fa-rupee-sign"></i>
                                                    {{ $bill->gst_amount }}</span>
                                            </li>

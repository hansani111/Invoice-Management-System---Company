        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box">
                    <h4 class="page-title font-weight-bold text-uppercase"> Edit Invoice </h4>
                </div>
            </div>
        </div>
        <!-- end page title -->
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <hr>
                        <form class="needs-validation" method="post" action="{{ route('update-invoice', $invoice->id) }}">
                            @csrf
                            @method('PUT')
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" id="state" name="state" value="{{$invoice->company->state}}" class="form-control border"
                                ...
                                @foreach($invoice->invoiceItems as $key => $item)
                                    <div class="row show_item">
                                        <div class="col-md-4 mb-3">
                                            <input type="text" name="description[]" placeholder="Enter Description" class="form-control" value="{{ $item->description }}" required>
                                        </div>
                            
                                        <div class="col-md-3 mb-3">
                                            <input type="number" name="qty[]" placeholder="Enter Quantity" class="form-control quantity" value="{{ $item->qty }}" required>
                                        </div>
                            
                                        <div class="col-md-3 mb-3">
                                            <input type="text" name="amount[]" placeholder="Enter Amount" class="form-control amount" value="{{ $item->amount }}" required>
                                        </div>
                            ...
                            <div id="show_item">
                                <div class="row show_item">
                                    <div class="col-md-4 mb-3">
                                        <input type="text" name="description[]" value="{{$item->description}}" placeholder="Enter Description"
                                            class="form-control" required>

                                    </div>

                                    <div class="col-md-3 mb-3">
                                        <input type="number" id="quantity" name="qty[]" value="{{$item->qty}}" placeholder="Enter Quantity"
                                            class="form-control quantity" required>

                                    </div>

                                    <div class="col-md-3 mb-3">
                                        <input type="text" name="amount[]"  value="{{$item->amount}}" placeholder="Enter Amount"
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-4 border p-2">
                                    <input class="form-control" type="text" value="{{ $invoice->invoice_amount }}"
                                        name="invoice_amount" id="invoiceAmountInput">
                                </div>
                            </div>
    ...
    <script>
        $(document).ready(function() {
            $('#validationCustom01').change(function() {
                ...
                $.ajax({
                    url: '/get-state/' + companyId, 
                    type: 'GET',
                    success: function(response) {
                        $('#state').val(response.state);
                        // updateTaxRates(response.state); 
                    },
                    error: function(xhr) {
                        // Handle error if any
